...
public class StratostoreService implements ContentRepo<Share, String> {
    ...
    public Share read(String id) {
        ...
        MediaType mediaType = MediaType.parseMediaType(TikaUtils.detectType(content));
        return new Share(mediaType, Long.valueOf(content.length), new ByteArrayInputStream(content));
    }
